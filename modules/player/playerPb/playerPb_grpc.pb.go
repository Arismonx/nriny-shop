...
type PlayerGrpcServiceClient interface {
	CredentialSearch(ctx context.Context, in *PlayerCredenrialSearchReq, opts ...grpc.CallOption) (*PlayerProfile, error)
...
func (c *playerGrpcServiceClient) CredentialSearch(ctx context.Context, in *PlayerCredenrialSearchReq, opts ...grpc.CallOption) (*PlayerProfile, error) {
...
type PlayerGrpcServiceServer interface {
	CredentialSearch(context.Context, *PlayerCredenrialSearchReq) (*PlayerProfile, error)
...
func (UnimplementedPlayerGrpcServiceServer) CredentialSearch(context.Context, *PlayerCredenrialSearchReq) (*PlayerProfile, error) {
...
func _PlayerGrpcService_CredentialSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PlayerCredenrialSearchReq)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlayerGrpcServiceServer).CredentialSearch(ctx, req.(*PlayerCredenrialSearchReq))
	}
