...
type PlayerCredenrialSearchReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PlayerCredenrialSearchReq) Reset() {
	*x = PlayerCredenrialSearchReq{}
	mi := &file_modules_player_playerPb_playerPb_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PlayerCredenrialSearchReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlayerCredenrialSearchReq) ProtoMessage() {}

func (x *PlayerCredenrialSearchReq) ProtoReflect() protoreflect.Message {
	mi := &file_modules_player_playerPb_playerPb_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlayerCredenrialSearchReq.ProtoReflect.Descriptor instead.
func (*PlayerCredenrialSearchReq) Descriptor() ([]byte, []int) {
	return file_modules_player_playerPb_playerPb_proto_rawDescGZIP(), []int{1}
}

func (x *PlayerCredenrialSearchReq) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *PlayerCredenrialSearchReq) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_modules_player_playerPb_playerPb_proto_rawDesc = "" +
	"\n" +
	"&modules/player/playerPb/playerPb.proto\"\xab\x01\n" +
	...
	"\x19PlayerCredenrialSearchReq\x12\x14\n" +
	...
	"\abalance\x18\x02 \x01(\x01R\abalance2\xf9\x01\n" +
	"\x11PlayerGrpcService\x12>\n" +
	"\x10CredentialSearch\x12\x1a.PlayerCredenrialSearchReq\x1a\x0e.PlayerProfile\x12R\n" +
	"\x1dFindOnePlayerProfileToRefresh\x12!.FindOnePlayerProfileToRefreshReq\x1a\x0e.PlayerProfile\x12P\n" +
	"\x16GetPlayerSavingAccount\x12\x1a.GetPlayerSavingAccountReq\x1a\x1a.GetPlayerSavingAccountResB Z\x1egithub.com/Arismonx/nriny-shopb\x06proto3"
...
var file_modules_player_playerPb_playerPb_proto_goTypes = []any{
	...
	(*PlayerCredenrialSearchReq)(nil),        // 1: PlayerCredenrialSearchReq
...
var file_modules_player_playerPb_playerPb_proto_depIdxs = []int32{
	1, // 0: PlayerGrpcService.CredentialSearch:input_type -> PlayerCredenrialSearchReq
