...
const (
	ItemGrpcService_FindItemInIds_FullMethodName = "/ItemGrpcService/FindItemInIds"
)
...
type ItemGrpcServiceClient interface {
	FindItemInIds(ctx context.Context, in *FindItemInIdsReq, opts ...grpc.CallOption) (*FindItemInIdsRes, error)
}
...
func (c *itemGrpcServiceClient) FindItemInIds(ctx context.Context, in *FindItemInIdsReq, opts ...grpc.CallOption) (*FindItemInIdsRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FindItemInIdsRes)
	err := c.cc.Invoke(ctx, ItemGrpcService_FindItemInIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ItemGrpcServiceServer interface {
	FindItemInIds(context.Context, *FindItemInIdsReq) (*FindItemInIdsRes, error)
...
func (UnimplementedItemGrpcServiceServer) FindItemInIds(context.Context, *FindItemInIdsReq) (*FindItemInIdsRes, error) {
...
func _ItemGrpcService_FindItemInIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ItemGrpcService_FindItemInIds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ItemGrpcServiceServer).FindItemInIds(ctx, req.(*FindItemInIdsReq))
	}
