...
type InventoryGrpcServiceClient interface {
	IsAvailableToSell(ctx context.Context, in *IsAvaibleToSellReq, opts ...grpc.CallOption) (*IsAvaibleToSellRes, error)
}
...
func (c *inventoryGrpcServiceClient) IsAvailableToSell(ctx context.Context, in *IsAvaibleToSellReq, opts ...grpc.CallOption) (*IsAvaibleToSellRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsAvaibleToSellRes)
...
type InventoryGrpcServiceServer interface {
	IsAvailableToSell(context.Context, *IsAvaibleToSellReq) (*IsAvaibleToSellRes, error)
...
func (UnimplementedInventoryGrpcServiceServer) IsAvailableToSell(context.Context, *IsAvaibleToSellReq) (*IsAvaibleToSellRes, error) {
...
func _InventoryGrpcService_IsAvailableToSell_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryGrpcServiceServer).IsAvailableToSell(ctx, req.(*IsAvaibleToSellReq))
	}
